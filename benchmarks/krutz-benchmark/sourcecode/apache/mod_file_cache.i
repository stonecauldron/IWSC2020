...
# 26 "/Users/cauldron/Development/code-clones/httpd-2.2.14/srclib/apr/include/apr_mmap.h"
...
# 27 "/Users/cauldron/Development/code-clones/httpd-2.2.14/srclib/apr/include/apr_mmap.h" 2
...
# 29 "/Users/cauldron/Development/code-clones/httpd-2.2.14/srclib/apr/include/apr_tables.h"
...
# 29 "/Users/cauldron/Development/code-clones/httpd-2.2.14/srclib/apr/include/apr_file_info.h" 2
...
# 34 "/Users/cauldron/Development/code-clones/httpd-2.2.14/srclib/apr/include/apr_file_info.h" 2
...
apr_status_t apr_temp_dir_get(const char **temp_dir,
                                           apr_pool_t *p);
# 30 "/Users/cauldron/Development/code-clones/httpd-2.2.14/srclib/apr/include/apr_mmap.h" 2
...
# 80 "mod_file_cache.c" 2
# 1 "/Users/cauldron/Development/code-clones/httpd-2.2.14/srclib/apr-util/include/apr_buckets.h" 1
# 28 "/Users/cauldron/Development/code-clones/httpd-2.2.14/srclib/apr-util/include/apr_buckets.h"
# 1 "/Users/cauldron/Development/code-clones/httpd-2.2.14/srclib/apr-util/include/apu.h" 1
# 29 "/Users/cauldron/Development/code-clones/httpd-2.2.14/srclib/apr-util/include/apr_buckets.h" 2
# 1 "/Users/cauldron/Development/code-clones/httpd-2.2.14/srclib/apr/include/apr_network_io.h" 1
# 31 "/Users/cauldron/Development/code-clones/httpd-2.2.14/srclib/apr/include/apr_network_io.h"
...
apr_status_t apr_bucket_file_enable_mmap(apr_bucket *b,
                                                      int enabled);
# 81 "mod_file_cache.c" 2


# 1 "/Users/cauldron/Development/code-clones/httpd-2.2.14/srclib/apr/include/apr_want.h" 1
# 84 "mod_file_cache.c" 2
...
# 26 "/Users/cauldron/Development/code-clones/httpd-2.2.14/include/ap_config.h"
...
# 27 "/Users/cauldron/Development/code-clones/httpd-2.2.14/include/ap_config.h" 2
...
# 93 "mod_file_cache.c" 2
# 1 "/Users/cauldron/Development/code-clones/httpd-2.2.14/include/http_log.h" 1
# 33 "/Users/cauldron/Development/code-clones/httpd-2.2.14/include/http_log.h"
# 1 "/Users/cauldron/Development/code-clones/httpd-2.2.14/srclib/apr/include/apr_thread_proc.h" 1
# 31 "/Users/cauldron/Development/code-clones/httpd-2.2.14/srclib/apr/include/apr_thread_proc.h"
...
# 32 "/Users/cauldron/Development/code-clones/httpd-2.2.14/srclib/apr/include/apr_thread_proc.h" 2
...
# 34 "/Users/cauldron/Development/code-clones/httpd-2.2.14/include/http_log.h" 2
...
# 34 "/Users/cauldron/Development/code-clones/httpd-2.2.14/srclib/apr/include/apr_portable.h"
...
# 35 "/Users/cauldron/Development/code-clones/httpd-2.2.14/include/http_protocol.h" 2
...
# 96 "mod_file_cache.c" 2
# 1 "/Users/cauldron/Development/code-clones/httpd-2.2.14/include/http_core.h" 1
# 31 "/Users/cauldron/Development/code-clones/httpd-2.2.14/include/http_core.h"
...
# 32 "/Users/cauldron/Development/code-clones/httpd-2.2.14/include/http_core.h" 2
...
# 97 "mod_file_cache.c" 2

module file_cache_module;
...
static void cache_the_file(cmd_parms *cmd, const char *filename, int mmap)
{
    ...
    if (!fspec) {
        ap_log_error("mod_file_cache.c",138, 4, (20000 + 24), cmd->server,
                     "mod_file_cache: invalid file path "
                     "%s, skipping", filename);
        return;
    }
    if ((rc = apr_stat(&tmp.finfo, fspec, 0x00008170,
                                 cmd->temp_pool)) != 0) {
        ap_log_error("mod_file_cache.c",145, 4, rc, cmd->server,
            "mod_file_cache: unable to stat(%s), skipping", fspec);
        return;
    }
    if (tmp.finfo.filetype != APR_REG) {
        ap_log_error("mod_file_cache.c",150, 4, 0, cmd->server,
            "mod_file_cache: %s isn't a regular file, skipping", fspec);
        return;
    }
    if (tmp.finfo.size > 16777216) {
        ap_log_error("mod_file_cache.c",155, 4, 0, cmd->server,
            "mod_file_cache: %s is too large to cache, skipping", fspec);
        return;
    }

    rc = apr_file_open(&fd, fspec, 0x00001 | 0x00020 | 0x00200,
                       0x0FFF, cmd->pool);
    if (rc != 0) {
        ap_log_error("mod_file_cache.c",163, 4, rc, cmd->server,
    ...
    new_file = __builtin___memset_chk (apr_palloc(cmd->pool, sizeof(a_file)), 0, sizeof(a_file), __builtin_object_size (apr_palloc(cmd->pool, sizeof(a_file)), 0));
    ...
    if (mmap) {
        ...
        if ((rc = apr_mmap_create(&new_file->mm, fd, 0,
                                  ...
                                  1, cmd->pool)) != 0) {
            apr_file_close(fd);
            ap_log_error("mod_file_cache.c",183, 4, rc, cmd->server,
    ...
    apr_snprintf(new_file->sizestr, sizeof new_file->sizestr, "%" "ld", new_file->finfo.size);

    sconf = (((void **)(cmd->server->module_config))[(&file_cache_module)->module_index]);
...
static int file_cache_xlat(request_rec *r)
{
    ...
    sconf = (((void **)(r->server->module_config))[(&file_cache_module)->module_index]);
    ...
    match = (a_file *) apr_hash_get(sconf->fileht, r->filename, (-1));
    if (match == ((void*)0))
        return -1;


    ((((void **)(r->request_config))[(&file_cache_module)->module_index]) = (match));
...
static int file_cache_handler(request_rec *r)
{
    ...
    if (r->method_number != 0) return -1;


    match = (((void **)(r->request_config))[(&file_cache_module)->module_index]);
...
{
{ "cachefile", { .take1=cachefilehandle }, ((void*)0), 128, ITERATE, "A space separated list of files to add to the file handle cache at config time" },

{ "mmapfile", { .take1=cachefilemmap }, ((void*)0), 128, ITERATE, "A space separated list of files to mmap at config time" },
...
{
    ap_hook_handler(file_cache_handler, ((void*)0), ((void*)0), 20);
    ap_hook_post_config(file_cache_post_config, ((void*)0), ((void*)0), 10);
    ap_hook_translate_name(file_cache_xlat, ((void*)0), ((void*)0), 10);
...
module file_cache_module =
{
    20051115, 23, -1, "mod_file_cache.c", ((void*)0), ((void*)0), 0x41503232UL, ((void*)0),
    ((void*)0),
    ((void*)0),
