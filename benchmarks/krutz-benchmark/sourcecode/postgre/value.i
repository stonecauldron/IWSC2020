...
makeInteger(long i)
{
 Value *v = ((Value *) ({ Node *_result; ((void)((bool) 1)); _result = (Node *) ( ( ((sizeof(Value)) & (sizeof(long) - 1)) == 0 && (sizeof(Value)) <= 1024 && 1024 != 0 && (0) == 0 ) ? MemoryContextAllocZeroAligned(CurrentMemoryContext, sizeof(Value)) : MemoryContextAllocZero(CurrentMemoryContext, sizeof(Value)) ); _result->type = (T_Value); _result; }));
