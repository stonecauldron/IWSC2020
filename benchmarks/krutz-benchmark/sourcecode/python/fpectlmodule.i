...
static PyMethodDef fpectl_methods[] = {
    {"turnon_sigfpe", (PyCFunction) turnon_sigfpe, 0x0001},
    {"turnoff_sigfpe", (PyCFunction) turnoff_sigfpe, 0x0001},
    {0,0}
};
...
{
    PyObject *m, *d;
    m = Py_InitModule4_64("fpectl", fpectl_methods, (char *)((void*)0), (PyObject *)((void*)0), 1013);
    if (m == ((void*)0))
     return;
    d = PyModule_GetDict(m);
    fpe_error = PyErr_NewException("fpectl.error", ((void*)0), ((void*)0));
    if (fpe_error != ((void*)0))
