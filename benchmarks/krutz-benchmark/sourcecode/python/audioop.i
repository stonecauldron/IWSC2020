...
# 44 "./Include/Python.h" 2
# 55 "./Include/Python.h"
# 1 "/usr/include/assert.h" 1 3 4
# 56 "./Include/Python.h" 2
...
# 8 "./Include/pyport.h" 2
# 73 "./Include/pyport.h"
typedef uintptr_t Py_uintptr_t;
typedef intptr_t Py_intptr_t;
# 97 "./Include/pyport.h"
typedef ssize_t Py_ssize_t;
# 204 "./Include/pyport.h"
...
# 213 "./Include/pyport.h" 2
# 269 "./Include/pyport.h"
...
# 270 "./Include/pyport.h" 2
# 58 "./Include/Python.h" 2
# 76 "./Include/Python.h"
# 1 "./Include/pymem.h" 1
# 50 "./Include/pymem.h"
...
# 720 "./Include/object.h"
extern PyObject _Py_NotImplementedStruct;
# 734 "./Include/object.h"
extern int _Py_SwappedOp[];
# 846 "./Include/object.h"
...
# 56 "./Include/unicodeobject.h" 2
# 118 "./Include/unicodeobject.h"
# 1 "/usr/include/wchar.h" 1 3 4
...
# 466 "./Include/unicodeobject.h"
int PyUnicodeUCS2_Resize(
    PyObject **unicode,
    Py_ssize_t length
    );
# 488 "./Include/unicodeobject.h"
...
# 1001 "./Include/unicodeobject.h"
PyObject* PyUnicodeUCS2_Concat(
    PyObject *left,
    PyObject *right
    );
# 1017 "./Include/unicodeobject.h"
...
# 1061 "./Include/unicodeobject.h"
PyObject* PyUnicodeUCS2_RSplit(
    PyObject *s,
    PyObject *sep,
    Py_ssize_t maxsplit
    );
# 1079 "./Include/unicodeobject.h"
...
typedef
    enum {PyGILState_LOCKED, PyGILState_UNLOCKED}
        PyGILState_STATE;
# 155 "./Include/pystate.h"
PyGILState_STATE PyGILState_Ensure(void);
# 165 "./Include/pystate.h"
...
PyObject * Py_InitModule4_64(const char *name, PyMethodDef *methods,
                                      ...
                                      int apiver);
# 128 "./Include/modsupport.h"
extern char * _Py_PackageContext;
# 120 "./Include/Python.h" 2
# 1 "./Include/pythonrun.h" 1
# 17 "./Include/pythonrun.h"
typedef struct {
 int cf_flags;
} PyCompilerFlags;
...
# 457 "./Include/abstract.h"
     PyObject * PyObject_GetItem(PyObject *o, PyObject *key);
# 466 "./Include/abstract.h"
...
# 514 "./Include/abstract.h"
     int PyObject_AsReadBuffer(PyObject *obj,
       const void **buffer,
       Py_ssize_t *buffer_len);
# 530 "./Include/abstract.h"
     int PyObject_AsWriteBuffer(PyObject *obj,
        void **buffer,
        Py_ssize_t *buffer_len);
# 547 "./Include/abstract.h"
     PyObject * PyObject_GetIter(PyObject *);
# 556 "./Include/abstract.h"
...
# 574 "./Include/abstract.h"
     PyObject * PyNumber_Add(PyObject *o1, PyObject *o2);
# 583 "./Include/abstract.h"
     PyObject * PyNumber_Subtract(PyObject *o1, PyObject *o2);
# 592 "./Include/abstract.h"
     PyObject * PyNumber_Multiply(PyObject *o1, PyObject *o2);
# 602 "./Include/abstract.h"
     PyObject * PyNumber_Divide(PyObject *o1, PyObject *o2);
# 611 "./Include/abstract.h"
     PyObject * PyNumber_FloorDivide(PyObject *o1, PyObject *o2);
# 621 "./Include/abstract.h"
     PyObject * PyNumber_TrueDivide(PyObject *o1, PyObject *o2);
# 631 "./Include/abstract.h"
     PyObject * PyNumber_Remainder(PyObject *o1, PyObject *o2);
# 641 "./Include/abstract.h"
     PyObject * PyNumber_Divmod(PyObject *o1, PyObject *o2);
# 651 "./Include/abstract.h"
     PyObject * PyNumber_Power(PyObject *o1, PyObject *o2,
                                          PyObject *o3);
# 661 "./Include/abstract.h"
...
# 695 "./Include/abstract.h"
     PyObject * PyNumber_Lshift(PyObject *o1, PyObject *o2);
# 705 "./Include/abstract.h"
     PyObject * PyNumber_Rshift(PyObject *o1, PyObject *o2);
# 714 "./Include/abstract.h"
     PyObject * PyNumber_And(PyObject *o1, PyObject *o2);
# 724 "./Include/abstract.h"
     PyObject * PyNumber_Xor(PyObject *o1, PyObject *o2);
# 734 "./Include/abstract.h"
     PyObject * PyNumber_Or(PyObject *o1, PyObject *o2);
# 767 "./Include/abstract.h"
...
# 994 "./Include/abstract.h"
     int PySequence_SetItem(PyObject *o, Py_ssize_t i, PyObject *v);
# 1003 "./Include/abstract.h"
...
# 1078 "./Include/abstract.h"
     Py_ssize_t PySequence_Count(PyObject *o, PyObject *value);
# 1087 "./Include/abstract.h"
     int PySequence_Contains(PyObject *seq, PyObject *ob);
# 1096 "./Include/abstract.h"
     Py_ssize_t _PySequence_IterSearch(PyObject *seq,
          PyObject *obj, int operation);
# 1111 "./Include/abstract.h"
     int PySequence_In(PyObject *o, PyObject *value);
# 1122 "./Include/abstract.h"
     Py_ssize_t PySequence_Index(PyObject *o, PyObject *value);
# 1132 "./Include/abstract.h"
     PyObject * PySequence_InPlaceConcat(PyObject *o1, PyObject *o2);
# 1141 "./Include/abstract.h"
     PyObject * PySequence_InPlaceRepeat(PyObject *o, Py_ssize_t count);
# 1152 "./Include/abstract.h"
     int PyMapping_Check(PyObject *o);
# 1161 "./Include/abstract.h"
     Py_ssize_t PyMapping_Size(PyObject *o);
# 1171 "./Include/abstract.h"
     Py_ssize_t PyMapping_Length(PyObject *o);
# 1195 "./Include/abstract.h"
     int PyMapping_HasKeyString(PyObject *o, char *key);
# 1205 "./Include/abstract.h"
     int PyMapping_HasKey(PyObject *o, PyObject *key);
# 1248 "./Include/abstract.h"
...
audioop_getsample(PyObject *self, PyObject *args)
{
        ...
        if ( size == 1 ) val = (int)*((signed char *)(cp+i));
        else if ( size == 2 ) val = (int)*((short *)(cp+i*2));
        else if ( size == 4 ) val = (int)*((Py_Int32 *)(cp+i*4));
...
audioop_max(PyObject *self, PyObject *args)
{
        ...
        for ( i=0; i<len; i+= size) {
                if ( size == 1 ) val = (int)*((signed char *)(cp+i));
                else if ( size == 2 ) val = (int)*((short *)(cp+i));
                else if ( size == 4 ) val = (int)*((Py_Int32 *)(cp+i));
                if ( val < 0 ) val = (-val);
                if ( val > max ) max = val;
        }
...
audioop_avgpp(PyObject *self, PyObject *args)
{
        ...
        if ( size == 1 ) prevval = (int)*((signed char *)(cp+0));
        else if ( size == 2 ) prevval = (int)*((short *)(cp+0));
        else if ( size == 4 ) prevval = (int)*((Py_Int32 *)(cp+0));
        if ( size == 1 ) val = (int)*((signed char *)(cp+size));
        else if ( size == 2 ) val = (int)*((short *)(cp+size));
        else if ( size == 4 ) val = (int)*((Py_Int32 *)(cp+size));
...
audioop_cross(PyObject *self, PyObject *args)
{
        ...
        prevval = 17;
        for ( i=0; i<len; i+= size) {
                if ( size == 1 ) val = ((int)*((signed char *)(cp+i))) >> 7;
                else if ( size == 2 ) val = ((int)*((short *)(cp+i))) >> 15;
                else if ( size == 4 ) val = ((int)*((Py_Int32 *)(cp+i))) >> 31;
                val = val & 1;
...
audioop_mul(PyObject *self, PyObject *args)
{
        ...
        rv = PyString_FromStringAndSize(((void*)0), len);
        if ( rv == 0 )
                return 0;
        ...
        for ( i=0; i < len; i += size ) {
                ...
                val = (int)fval;
                if ( size == 1 ) *((signed char *)(ncp+i)) = (signed char)val;
                else if ( size == 2 ) *((short *)(ncp+i)) = (short)val;
                else if ( size == 4 ) *((Py_Int32 *)(ncp+i)) = (Py_Int32)val;
        }
        return rv;
}
...
audioop_tomono(PyObject *self, PyObject *args)
{
        ...
        rv = PyString_FromStringAndSize(((void*)0), len/2);
        if ( rv == 0 )
                return 0;
        ncp = (signed char *)PyString_AsString(rv);
        ...
        for ( i=0; i < len; i += size*2 ) {
                if ( size == 1 ) val1 = (int)*((signed char *)(cp+i));
                else if ( size == 2 ) val1 = (int)*((short *)(cp+i));
                else if ( size == 4 ) val1 = (int)*((Py_Int32 *)(cp+i));
                if ( size == 1 ) val2 = (int)*((signed char *)(cp+i+1));
                else if ( size == 2 ) val2 = (int)*((short *)(cp+i+2));
                else if ( size == 4 ) val2 = (int)*((Py_Int32 *)(cp+i+4));
                fval = (double)val1*fac1 + (double)val2*fac2;
                if ( fval > maxval ) fval = maxval;
                else if ( fval < -maxval ) fval = -maxval;
                val1 = (int)fval;
                if ( size == 1 ) *((signed char *)(ncp+i/2)) = (signed char)val1;
                else if ( size == 2 ) *((short *)(ncp+i/2)) = (short)val1;
                else if ( size == 4 ) *((Py_Int32 *)(ncp+i/2))= (Py_Int32)val1;
        }
        return rv;
}
...
audioop_tostereo(PyObject *self, PyObject *args)
{
        ...
        for ( i=0; i < len; i += size ) {
                ...
                if ( size == 1 ) *((signed char *)(ncp+i*2+1)) = (signed char)val2;
                else if ( size == 2 ) *((short *)(ncp+i*2+2)) = (short)val2;
                else if ( size == 4 ) *((Py_Int32 *)(ncp+i*2+4)) = (Py_Int32)val2;
        }
        return rv;
}
...
audioop_add(PyObject *self, PyObject *args)
{
        ...
        rv = PyString_FromStringAndSize(((void*)0), len1);
        if ( rv == 0 )
                return 0;
        ncp = (signed char *)PyString_AsString(rv);

        for ( i=0; i < len1; i += size ) {
                if ( size == 1 ) val1 = (int)*((signed char *)(cp1+i));
                else if ( size == 2 ) val1 = (int)*((short *)(cp1+i));
                else if ( size == 4 ) val1 = (int)*((Py_Int32 *)(cp1+i));

                if ( size == 1 ) val2 = (int)*((signed char *)(cp2+i));
                else if ( size == 2 ) val2 = (int)*((short *)(cp2+i));
                else if ( size == 4 ) val2 = (int)*((Py_Int32 *)(cp2+i));
                ...
                if ( size == 1 ) *((signed char *)(ncp+i)) = (signed char)newval;
                else if ( size == 2 ) *((short *)(ncp+i)) = (short)newval;
                else if ( size == 4 ) *((Py_Int32 *)(ncp+i)) = (Py_Int32)newval;
        }
        return rv;
}
...
audioop_bias(PyObject *self, PyObject *args)
{
        ...
        for ( i=0; i < len; i += size ) {
                ...
                if ( size == 1 ) *((signed char *)(ncp+i)) = (signed char)(val+bias);
                else if ( size == 2 ) *((short *)(ncp+i)) = (short)(val+bias);
                else if ( size == 4 ) *((Py_Int32 *)(ncp+i)) = (Py_Int32)(val+bias);
        }
        return rv;
}
...
audioop_reverse(PyObject *self, PyObject *args)
{
        ...
        for ( i=0; i < len; i += size ) {
                if ( size == 1 ) val = ((int)*((signed char *)(cp+i))) << 8;
                else if ( size == 2 ) val = (int)*((short *)(cp+i));
                else if ( size == 4 ) val = ((int)*((Py_Int32 *)(cp+i))) >> 16;

                j = len - i - size;

                if ( size == 1 ) *((signed char *)(ncp+j)) = (signed char)(val >> 8);
                else if ( size == 2 ) *((short *)(ncp+j)) = (short)(val);
                else if ( size == 4 ) *((Py_Int32 *)(ncp+j)) = (Py_Int32)(val<<16);
        }
        return rv;
}
...
audioop_lin2lin(PyObject *self, PyObject *args)
{
        ...
        rv = PyString_FromStringAndSize(((void*)0), (len/size)*size2);
        if ( rv == 0 )
                return 0;
        ncp = (unsigned char *)PyString_AsString(rv);
        ...
        for ( i=0, j=0; i < len; i += size, j += size2 ) {
                ...
                if ( size2 == 1 ) *((signed char *)(ncp+j)) = (signed char)(val >> 8);
                else if ( size2 == 2 ) *((short *)(ncp+j)) = (short)(val);
                else if ( size2 == 4 ) *((Py_Int32 *)(ncp+j)) = (Py_Int32)(val<<16);
        }
        return rv;
}
...
audioop_ratecv(PyObject *self, PyObject *args)
{
        ...
        PyObject *state, *samps, *str, *rv = ((void*)0);
        int bytes_per_frame;
...

        {
                ...
                if (q+1 < 0 ||
                    ...
                    nbytes / bytes_per_frame != ceiling)
                        ...
                        str = PyString_FromStringAndSize(((void*)0), nbytes);
                ...
                while (d < 0) {
                        if (len == 0) {
                                ...
                                if (len == 0) {
                                        ...
                                        if ( --(str)->ob_refcnt != 0) ; else ( (*((PyObject *)(str))->ob_type->tp_dealloc)((PyObject *)((PyObject *)(str))));
                                        str = rv;
                                } else if (_PyString_Resize(&str, len) < 0)
                                        goto exit;
                                rv = Py_BuildValue("(O(iO))", str, d, samps);
                                if ( --(samps)->ob_refcnt != 0) ; else ( (*((PyObject *)(samps))->ob_type->tp_dealloc)((PyObject *)((PyObject *)(samps))));
                                if ( --(str)->ob_refcnt != 0) ; else ( (*((PyObject *)(str))->ob_type->tp_dealloc)((PyObject *)((PyObject *)(str))));
                                goto exit;
                        }
                        for (chan = 0; chan < nchannels; chan++) {
                                ...
                                if (size == 1)
                                    cur_i[chan] = ((int)*((signed char *)(cp+0))) << 8;
                                else if (size == 2)
                                    cur_i[chan] = (int)*((short *)(cp+0));
                                else if (size == 4)
                                    cur_i[chan] = ((int)*((Py_Int32 *)(cp+0))) >> 16;
                                cp += size;
                ...
                while (d >= 0) {
                        for (chan = 0; chan < nchannels; chan++) {
                                cur_o = (prev_i[chan] * d +
                                        ...
                                        outrate;
                                if (size == 1)
                                    *((signed char *)(ncp+0)) = (signed char)(cur_o >> 8);
                                else if (size == 2)
                                    *((short *)(ncp+0)) = (short)(cur_o);
                                else if (size == 4)
                                    *((Py_Int32 *)(ncp+0)) = (Py_Int32)(cur_o<<16);
                                ncp += size;
                        }
                        d -= inrate;
                }
...
audioop_lin2ulaw(PyObject *self, PyObject *args)
{
        ...
        rv = PyString_FromStringAndSize(((void*)0), len/size);
        if ( rv == 0 )
                return 0;
        ncp = (unsigned char *)PyString_AsString(rv);
...
audioop_ulaw2lin(PyObject *self, PyObject *args)
{
        ...
        for ( i=0; i < len*size; i += size ) {
                cval = *cp++;
                val = (_st_ulaw2linear16[cval]);

                if ( size == 1 ) *((signed char *)(ncp+i)) = (signed char)(val >> 8);
                else if ( size == 2 ) *((short *)(ncp+i)) = (short)(val);
                else if ( size == 4 ) *((Py_Int32 *)(ncp+i)) = (Py_Int32)(val<<16);
        }
        return rv;
}
...
audioop_lin2adpcm(PyObject *self, PyObject *args)
{
        ...
        str = PyString_FromStringAndSize(((void*)0), len/(size*2));
        if ( str == 0 )
                return 0;
...
audioop_adpcm2lin(PyObject *self, PyObject *args)
{
        ...
        for ( i=0; i < len*size*2; i += size ) {
                ...
                if ( size == 1 ) *((signed char *)(ncp+i)) = (signed char)(valpred >> 8);
                else if ( size == 2 ) *((short *)(ncp+i)) = (short)(valpred);
                else if ( size == 4 ) *((Py_Int32 *)(ncp+i)) = (Py_Int32)(valpred<<16);
        }
...
static PyMethodDef audioop_methods[] = {
        { "max", audioop_max, 0x0001 },
        { "minmax", audioop_minmax, 0x0001 },
        { "avg", audioop_avg, 0x0001 },
        { "maxpp", audioop_maxpp, 0x0001 },
        { "avgpp", audioop_avgpp, 0x0001 },
        { "rms", audioop_rms, 0x0001 },
        { "findfit", audioop_findfit, 0x0001 },
        { "findmax", audioop_findmax, 0x0001 },
        { "findfactor", audioop_findfactor, 0x0001 },
        { "cross", audioop_cross, 0x0001 },
        { "mul", audioop_mul, 0x0001 },
        { "add", audioop_add, 0x0001 },
        { "bias", audioop_bias, 0x0001 },
        { "ulaw2lin", audioop_ulaw2lin, 0x0001 },
        { "lin2ulaw", audioop_lin2ulaw, 0x0001 },
        { "alaw2lin", audioop_alaw2lin, 0x0001 },
        { "lin2alaw", audioop_lin2alaw, 0x0001 },
        { "lin2lin", audioop_lin2lin, 0x0001 },
        { "adpcm2lin", audioop_adpcm2lin, 0x0001 },
        { "lin2adpcm", audioop_lin2adpcm, 0x0001 },
        { "tomono", audioop_tomono, 0x0001 },
        { "tostereo", audioop_tostereo, 0x0001 },
        { "getsample", audioop_getsample, 0x0001 },
        { "reverse", audioop_reverse, 0x0001 },
        { "ratecv", audioop_ratecv, 0x0001 },
        { 0, 0 }
};
...
{
        PyObject *m, *d;
        m = Py_InitModule4_64("audioop", audioop_methods, (char *)((void*)0), (PyObject *)((void*)0), 1013);
        if (m == ((void*)0))
                return;
        d = PyModule_GetDict(m);
        if (d == ((void*)0))
                return;
        AudioopError = PyErr_NewException("audioop.error", ((void*)0), ((void*)0));
        if (AudioopError != ((void*)0))
